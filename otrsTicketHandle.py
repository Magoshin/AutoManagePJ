...
class OTRSApi(object):
    def __init__(self):
        ...
        self.base_url = "http://" + self.otrs_ip \
                        + "/otrs/nph-genericinterface.pl/Webservice/APITicket/"
...
# チケット作成
########################################
    def CreateTicket(self, title, type, queue, state,
                     priority, customer_user, subject, body):
