...
##  hostnm = param[1]
  ...
  # interfaceid を調べる
  response = api.request('hostinterface.get', {"output": "extend", "hostids": hostid})
  ...
  # IPアドレスを設定する
  response = api.request('hostinterface.update', {"hostid": hostid, "ip": ipaddr, "interfaceid": infid})
